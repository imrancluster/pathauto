...
class PathautoUnitTest extends KernelTestBase {
  ...
  public function testUpdateActions() {
    ...
    $this->assertAliasExists(array('source' => $node->url(), 'alias' => 'content/second-title'));
    ...
    $older_path = $this->assertAliasExists(array('source' => $node->url(), 'alias' => 'content/second-title'));
